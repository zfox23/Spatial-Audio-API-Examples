...
allVideosContainer.addEventListener("mousemove", e => {
    ...
    if (elementToMove.classList.contains("participantVideoContainer--mine")) {
        ...
        updateMyPosition({
            ...
            "z": -1 * linearScale(relativeParticipantVideoContainerPosition.y + boundingClientRect.height / 2 + VIDEO_TITLE_BAR_HEIGHT_PX, 0, window.innerHeight, -virtualSpaceDimensions.y / 2, virtualSpaceDimensions.y / 2)
        }, false);
